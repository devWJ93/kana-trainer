...
히라가나, 가타카나, 로마자 선택, 히라가나-가타카나 매칭 퀴즈는 기본 20문제를 중복 없이 출제합니다. 조사, 예문, 헷갈리는 문자 퀴즈는 기본 10문제를 중복 없이 출제합니다.
...
조사는 뜻 맞히기 퀴즈로 연습할 수 있습니다. 촉음 예문과 짧은 읽기 예문은 여러 예문을 섞어 로마자 입력 퀴즈로 출제됩니다. 헷갈리는 글자는 구분 힌트와 함께 2지선다 선택 퀴즈로 출제됩니다.

## 다음 업데이트 목표

- PyInstaller 패키징 설정 추가.
